	...
	constructor() {
		...
		this.state = {
			movies: [
				...
				{ _id: 3.0, Title: 'Sixteen Candles', ReleaseYear: '1984', Director: 'John Hughes', Description: "A girl's 'sweet' sixteenth birthday becomes anything but special, as she suffers from every embarrassment possible.", imdbRating: 7.0, imgURL: 'https://m.media-amazon.com/images/M/MV5BYjE2ZmZiMTYtODg3Ni00NzkyLWEyMjktMTUyMzEzYjdjNmFlXkEyXkFqcGdeQXVyMDAwMDAwNA@@._V1_.jpg', Genre: ['Comedy', 'Romance'], Actor: ['Molly Ringwald', 'Anthony Michael Hall'] },
