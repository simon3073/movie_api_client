...
function NavBarView(props) {
  ...
  console.log(
    '🚀 ~ file: navbar-view.jsx ~ line 23 ~ NavBarView ~ movieList',
    movieList
  )
  ...
  const handleOnSelect = (item) => {
    console.log(
      '🚀 ~ file: navbar-view.jsx ~ line 52 ~ handleOnSelect ~ item',
      item
    )
        ...
        {hideSearch || (
          <Nav className="ms-auto ml-4">
            <DropdownButton
              ...
              className="mr-4"
            >
              <Dropdown.Item onClick={() => saveRating(6)}>
                Rated 6 and Above
              </Dropdown.Item>
              <Dropdown.Item onClick={() => saveRating(7)}>
                Rated 7 and Above
              </Dropdown.Item>
              <Dropdown.Item onClick={() => saveRating(8)}>
                Rated 8 and Above
              </Dropdown.Item>
            </DropdownButton>
            <ReactSearchAutocomplete
              items={movieSearchList}
              onSelect={handleOnSelect}
              styling={searchStyleObj}
              autoFocus
            />
          </Nav>
        )}
