    ...
    if (validate()) {
      ...
      try {
        const response = await axios.post(
          'https://movie-app-3073.herokuapp.com/register',
          {
            Username: username,
            Password: password,
            Email: email,
        ...
        console.log(
          '🚀 ~ file: register-view.jsx ~ line 42 ~ handleSubmit ~ response.data',
          response.data
        )
        ...
        <Card.Body>
          ...
          <Form className="reg-form" onSubmit={handleSubmit}>
            <Form.Group controlId="username">
              ...
              />
              {values.usernameErr && (
                <p className="error-msg">{values.usernameErr}</p>
              )}
            </Form.Group>
            <Form.Group controlId="password">
              ...
              />
              {values.passwordErr && (
                <p className="error-msg">{values.passwordErr}</p>
              )}
            </Form.Group>
            <Form.Group controlId="email">
              ...
              />
              {values.emailErr && (
                <p className="error-msg">{values.emailErr}</p>
              )}
            </Form.Group>
            <Form.Group controlId="dob">
              ...
              />
              {values.birthdayErr && (
                <p className="error-msg">{values.birthdayErr}</p>
              )}
            </Form.Group>
